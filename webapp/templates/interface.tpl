...
<div class="body">
  <h1>{$interface} Interface (from platform <a href="{$ROOT}/platform/{$platform->name}">{$platform}</a>) - <a href="{$platform->sourceurl}{$interface->path}#{$interface->line}">Source</a></h1>
  <div class="code">
